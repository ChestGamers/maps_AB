  ...
  var CATEGORIES_CONFIG = [
    {
      ...
      subcategories: [
        ...
        { 
          id: 'medical', 
          title: 'Медицинский', 
          icons: ['icon/Гуманитарная помощь.png','icon/Медицинский контейнер.svg', 'icon/Сумка с медикаментами.svg', 'icon/Домашний набор первой помощи.svg', 'icon/Большой медицинский ящик.PNG'] 
        },
        { 
          id: 'clothes', 
          title: 'Одежда', 
