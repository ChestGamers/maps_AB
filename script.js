  ...
  var CATEGORIES_CONFIG = [
    {
      ...
      subcategories: [
        ...
        { 
          id: 'military', 
          title: 'Военный', 
          icons: ['icon/Военный ПК.svg', 'icon/Ящик с премиальным оружием.svg', 'icon/Большой ящик с оружием.svg', 'icon/Средний ящик с оружием.svg', 'icon/Деревянный ящик с оружием.svg', 'icon/Ящик с патронами.svg', 'icon/Ящик для гранат.svg', 'icon/Военные припасы.svg', 'icon/Длинный ящик с оружием.svg', 'icon/Сброшенный с воздуха контейнер.svg', 'icon/Военный ящик.png', 'icon/Ящик с припасами для полевого боя.png'] 
        },
        { 
          id: 'civilian', 
          title: 'Гражданский', 
          icons: ['icon/Средний ящик с припасами.png','icon/кейс с документами.svg', 'icon/Кейс для хранения.svg', 'icon/Ящики.svg', 'icon/Офисные ящики.webp', 'icon/Чемодан.svg', 'icon/Спортивная сумка.svg', 'icon/Проф. ящик с инструментами.svg', 'icon/Ящик с домашними инструментами.svg', 'icon/Деловой чемодан.svg', 'icon/homePC.svg', 'icon/Большой ящик.png', 'icon/Брошенный кейс.png', 'icon/Премиальный чемодан.png'] 
        },
        { 
          id: 'medical', 
          title: 'Медицинский', 
          icons: ['icon/Гуманитарная помощь.png','icon/Медицинский контейнер.svg', 'icon/Сумка с медикаментами.svg', 'icon/Домашний набор первой помощи.svg', 'icon/Большой медицинский ящик.PNG', 'icon/Сундук с экспериментальным предметом.png'] 
        },
        { 
          id: 'clothes', 
          title: 'Одежда', 
    ...
    { id: 'interact', title: 'Объекты взаимодействия', icons: ['icon/Приёмное устр. для припасов.svg', 'icon/Военный терминал.png'] },
