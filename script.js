  ...
  var CATEGORIES_CONFIG = [
    {
      ...
      subcategories: [
        ...
        { 
          id: 'civilian', 
          title: 'Гражданский', 
          icons: ['icon/кейс с документами.svg', 'icon/Кейс для хранения.svg', 'icon/Ящики.svg', 'icon/Офисные ящики.webp', 'icon/Чемодан.svg', 'icon/Спортивная сумка.svg', 'icon/Проф. ящик с инструментами.svg', 'icon/Ящик с домашними инструментами.svg', 'icon/Деловой чемодан.svg', 'icon/homePC.svg', 'icon/Большой ящик.png', 'icon/Брошенный кейс.png', 'icon/Премиальный чемодан.png'] 
        },
        { 
          id: 'medical', 
          title: 'Медицинский', 
