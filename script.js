  ...
  var CATEGORIES_CONFIG = [
    {
      ...
      subcategories: [
        ...
        { 
          id: 'military', 
          title: 'Военный', 
          icons: ['icon/Военный ПК.svg', 'icon/Ящик с премиальным оружием.svg', 'icon/Большой ящик с оружием.svg', 'icon/Средний ящик с оружием.svg', 'icon/Деревянный ящик с оружием.svg', 'icon/Ящик с патронами.svg', 'icon/Ящик для гранат.svg', 'icon/Военные припасы.svg', 'icon/Длинный ящик с оружием.svg', 'icon/Сброшенный с воздуха контейнер.svg'] 
        },
        { 
          id: 'civilian', 
          title: 'Гражданский', 
